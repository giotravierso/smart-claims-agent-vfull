...
El script ejecuta cuatro expedientes predefinidos con una semilla aleatoria fija (`random.seed(20)`) para garantizar reproducibilidad en cada ejecución ante el tribunal:
